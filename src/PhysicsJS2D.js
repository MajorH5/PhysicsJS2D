    ...
    return class Physics {
        ...
        process (body, dt) {
            ...
            if (!body.ignoreGravity && body.velocity.y < this.terminalVelocity) {
                body.velocity.y += (this.gravity * body.gravityScale);
            }

            let oldPreviousX = body.previousPosition.x, oldPreviousY = body.previousPosition.y;
            ...
            if (!body.position.equals(new Vector2(oldPreviousX, oldPreviousY)) || !body.size.equals(body.previousSize)) {
